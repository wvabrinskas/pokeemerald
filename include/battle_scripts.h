...
extern const u8 BattleScript_MoveUsedIsBaked[];
extern const u8 BattleScript_MoveUsedIsBakedNoMore[];
...
extern const u8 BattleScript_MoveEffectBaked[];
...
extern const u8 BattleScript_IgnoresAndIsTooBaked[];
