...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .lvl = 21,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_RAPID_SPIN, MOVE_SHIT_ATTACK, MOVE_PSYBEAM, MOVE_ROCK_TOMB}
    },
    {
    .iv = 0,
    .lvl = 21,
...
static const struct TrainerMonItemCustomMoves sParty_MK_Matt[] = {
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_SWELLOW,
...
static const struct TrainerMonItemCustomMoves sParty_MK_Chunga[] = {
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_SWELLOW,
