...
const u8 gText_Luke_Littleroot[] = _("Come look at my \n FIRE stuff!");
...
const u8 gText_PkmnSoberedUp[] = _("{STR_VAR_1} sobered up.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Littleroot[] = _("BAYSIDE"); // Unused. Given the context, Briney may at one point have been able to sail the player here
...
const u8 gText_MenuOptionPC[] = _("PC");
...
const u8 gText_MudSlap24BP[] = _("SHIT-ATTACK{CLEAR_TO 0x4E}24BP");
