...
static const u8 sText_PkmnWasBaked[] = _("{B_EFF_NAME_WITH_PREFIX} became\nbaked!");
static const u8 sText_PkmnAlreadyConfused[] = _("{B_DEF_NAME_WITH_PREFIX} is\nalready confused!");
static const u8 sText_PkmnAlreadyBaked[] = _("{B_DEF_NAME_WITH_PREFIX} is\nalready baked!");
...
static const u8 sText_ItsTooBaked[] = _("{B_BUFF1} is too baked to attack!");
...
const u16 gTrainerItemCuredStatusStringIds[] =
{
    ...
    [AI_HEAL_BAKED]     = STRINGID_PKMNSITEMSOBERED,
};
...
static const u16 sGrammarMoveUsedTable[] =
{
    ...
    MOVE_SMOG, MOVE_BLUNT_PASS, MOVE_BONE_CLUB, MOVE_FLASH, MOVE_SPLASH,
