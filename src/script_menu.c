...
static void CreateStartMenuForPokenavTutorial(void)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_MenuOptionPC, 8, 57, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_MenuOptionExit, 8, 137, TEXT_SKIP_DRAW, NULL);
